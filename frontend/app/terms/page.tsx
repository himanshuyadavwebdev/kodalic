    ...
    <main className="min-h-screen w-full bg-white font-[Inter]">
      <div className="mx-auto max-w-3xl px-6 sm:px-10 lg:px-20 pt-10 pb-16">
        ...
        <div className="mt-8">
          ...
          <h1 className="mt-4 text-3xl font-bold tracking-tight text-[#161221]">Terms of Service</h1>
          <p className="mt-2 text-sm text-black/60">DEMO CONTENT — Placeholder terms for design testing.</p>
        </div>
        <div className="prose prose-sm mt-8 max-w-none text-black/70">
          <p>Demo placeholder terms. Replace with verified terms.</p>
          <h2 className="text-lg font-semibold text-[#161221]">1. Demo Terms</h2>
