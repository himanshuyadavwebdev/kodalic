...
export const DEMO_BLOG_POSTS: DemoBlogPost[] = [
  ...
  {
    slug: "demo-product-analytics",
    category: "Web Application",
    title: "DEMO: Building Analytics for Products",
    description: "DEMO ARTICLE CONTENT — Replace with approved Kodalic editorial content.",
  ...
  {
    slug: "demo-digital-product-tips",
    category: "Websites",
    title: "DEMO: Digital Product Tips for Teams",
    description: "DEMO ARTICLE CONTENT — Replace with approved Kodalic editorial content.",
    readingTime: "5 min read",
...
export const DEMO_CONTACT = {
  email: "demo@kodalic.example",
  phone: "+91 00000 00000",
  location: "DEMO LOCATION — Replace with verified location",
  availability: "DEMO AVAILABILITY — Replace with verified availability",
  responseTime: "DEMO RESPONSE TIME — Replace with verified response information",
  demo: true as const,
  label: "DEMO CONTACT",
};
